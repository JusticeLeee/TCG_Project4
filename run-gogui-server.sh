...
# command to launch
player='./nogo --shell --name="Hollow" --black="mcts N=10000 c=0.5 timer=n choose=visit_count cond=0 num_worker=4" --white="mcts N=10000 c=0.5 timer=n choose=visit_count cond=0 num_worker=4"'
# port for binding
port=${1:-auto}

...
P1B='./nogo --shell --name="Hollow-Black" --black="mcts N=2000 c=0.1 timer=n choose=win_rate"'
P1W='./nogo --shell --name="Hollow-White" --white="mcts N=2000 c=0.1 timer=n choose=win_rate"'
